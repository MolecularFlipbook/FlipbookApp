...
class Image(Widget):
	...
	def __init__(self, parent, name, img, size=[0, 0], pos=[0, 0],offset=[0,0],
				texco=[(0,0), (1,0), (1,1), (0,1)], sub_theme='', options=BGUI_CACHE):
	...
	def update_image(self, img):
		...
		if im_buf == None:
			logging.error("Unable to load the image %s" % img)
			return
