...
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/autotorsCommands.py,v 1.111.2.7 2012/11/07 23:35:31 rhuey Exp $
#
# $Id: autotorsCommands.py,v 1.111.2.7 2012/11/07 23:35:31 rhuey Exp $
#
#
#
#
...
"""
    ...
    def useFldRange(self, event=None):
        ...
        for ll in lines:
            ...
            if ll.find("#NELEMENTS")==0: 
                npts = map(float, ll[11:].strip().split())
            if ll.find("#CENTER")==0: 
                center = map(float, ll[8:].strip().split())
    ...
    def Accept_cb(self, event=None):
        ...
        if filename: apply(self.doitWrapper, (filename,), kw )
        self.form.withdraw()
