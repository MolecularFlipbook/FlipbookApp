...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/summarize_results4.py,v 1.20.2.2 2012/01/16 23:51:04 rhuey Exp $
#
# $Id: summarize_results4.py,v 1.20.2.2 2012/01/16 23:51:04 rhuey Exp $
#
import os, glob
