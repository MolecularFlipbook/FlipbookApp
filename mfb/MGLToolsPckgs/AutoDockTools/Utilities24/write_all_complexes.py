...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/write_all_complexes.py,v 1.2.8.1 2012/01/16 23:18:07 rhuey Exp $
#
# $Id: write_all_complexes.py,v 1.2.8.1 2012/01/16 23:18:07 rhuey Exp $
#
import os
