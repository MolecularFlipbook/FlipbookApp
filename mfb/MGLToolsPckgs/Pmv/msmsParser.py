...
# $Header: /opt/cvs/python/packages/share1.5/Pmv/msmsParser.py,v 1.9 2007/07/24 17:30:39 vareille Exp $
#
# $Id: msmsParser.py,v 1.9 2007/07/24 17:30:39 vareille Exp $
#
import os
...
##         self.vertInfo = Numeric.array(map(
