...
########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/gui/BasicWidgets/Tk/trees/tree.py,v 1.40.2.8 2011/07/29 18:07:19 sanner Exp $
#
# $Id: tree.py,v 1.40.2.8 2011/07/29 18:07:19 sanner Exp $
#
...
below self"""
    ...
    def fitText(self, x, y, tree, canvas, text):
    ...
    def drawNodeLabel(self, x, y):
        ...
        try:
            ...
            text = self.fitText(x, y, tree, canvas, origtext)
