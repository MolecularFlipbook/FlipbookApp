...
#############################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/DejaVu/ViewerGUI.py,v 1.233.2.8 2012/10/31 22:26:54 mgltools Exp $
#
# $Id: ViewerGUI.py,v 1.233.2.8 2012/10/31 22:26:54 mgltools Exp $
#
...
class ViewerGUI:
    ...
    def __init__(self, viewer, maxLights, maxClip, name='Viewer',
        ...
        #
        self.Xform = StringVar()
        self.Xform.set("Object")
        import Pmw
...
#                                        )
    ...
    def addOrient(self, event=None):
        ...
        c = self.viewer.currentCamera
        mini, maxi = self.viewer.rootObject.ComputeBB()
        lBox = maxi - mini
...
"""
    ...
    def showSSAOTool(self,event=None):
        ...
        #pass
        if not DejaVu.enableSSAO: return
	camera = self.viewer.currentCamera
        if not hasattr(self,"ssao_options_w"):
            ...
            for k in camera.SSAO_OPTIONS_ORDER:
                ...
                if k in ["do_noise","only_ssao","use_mask_depth","show_mask_depth",
                         "fog","use_fog","only_depth","mix_depth","negative","fix"]:
                    pw = Tkinter.IntVar()
